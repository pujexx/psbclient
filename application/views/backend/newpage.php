...
<script type="text/javascript">
    ...
    function kirim_page(){
        ...
        $(document).ready(function(){
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo site_url('admin/page/submitpage'); ?>",
                data: kirim,
                dataType: "",
                        ...
                        <td>
                            ...
                            <table border="0" cellpadding="0" cellspacing="0"  id="id-form">
                                <tr>
                                    ...
                                    <td><input type="text" class="inp-form"  name="nama" id="nama"/></td>
                                    <td></td>
                                </tr>
                                <tr>
                                    <th valign="top">Judul Halaman</th>
                                    <td><input type="text" class="inp-form"  name="judul" id="title_page" /><p id="link_gabung" style="color: red;"></p></td>
                                    <td ></td>
                                </tr>

                                <tr>
                                    <th valign="top">Content</th>
                                    <td> <textarea name="content_page" id="content_page"></textarea></td>
                                    <td></td>
                                </tr>
                                <tr>

...
function delete_artikel(id,target){
    $(document).ready(function(){
        if(confirm("Apakah Anda yakin")){
           $.ajax({
              type :"POST",
                url :"<?php echo site_url('admin/artikel/deleteone')?>",
              data : "id="+id,
        ...
        <td>
            ...
            <div id="content-table-inner">
                ...
                <div id="table-content">
                    ...
                    <form id="mainform" action="">
                        ...
                        <table border="0" width="100%" cellpadding="0" cellspacing="0" id="product-table">
                            <tr>
                                ...
                                <th class="table-header-repeat line-left minwidth-1"><a href="">Artikel</a></th>
                            ...
                            <tr class="artikellist<?php echo $artikel['id']?>">
                                    <td><input  type="checkbox"/></td>
                                    <td><?php echo $artikel['title'] ?></td>

                                    <td><?php echo word_limiter($artikel['content'], 10); ?></td>
                                    <td><?php echo $artikel['tanggal'] ?></td>
                                    <td><?php echo $artikel['id_kategori']; ?></td>
                                    <td><?php echo $artikel['id_user']; ?></td>
                                    <td><?php
                                if ($artikel['aktif'] == 1) {
                                    echo "aktif";
                                } else {
                            ...
                            ?></td>
                                <td class="options-width">
                                    ...
                                    <a href="javascript:void(0);" title="Delete" class="icon-2 info-tooltip" onclick="delete_artikel(<?php echo $artikel['id']?>,'artikellist<?php echo $artikel['id']?>')"></a>
                  ...
                  <div id="actions-box">
                      <a class="<?php echo site_url('admin/artikel/newartikel');?>" href="">Artikel Baru</a>
                    <div class="clear"></div>
                  </div>
                    <!--  end content-table  -->
